...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        int index = 0;
        while (index < DIGIT_BUTTONS) {
            this.bDigits[index] = new JButton(Integer.toString(index));
            index++;
        }
        ...
        //Calculator operational buttons
        ...
        //Digits buttons
        int counter = 0;
        while (counter < DIGIT_BUTTONS) {
            this.bDigits[counter].addActionListener(this);
            counter++;
        }
